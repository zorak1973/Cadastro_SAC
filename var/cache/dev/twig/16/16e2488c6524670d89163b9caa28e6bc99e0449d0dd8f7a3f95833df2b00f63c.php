...
class __TwigTemplate_e6d44d56b5e8f2a34f8f233f7f5ad91ff181aeda427c5ada4fee1fa3ab8c5f35 extends Twig_Template
{
    ...
    {
        $__internal_34d39031ccb5925bc57011c4e6c715da214249c79d37e269d09a16d83b0c7ed0 = $this->env->getExtension("Symfony\\Bundle\\WebProfilerBundle\\Twig\\WebProfilerExtension");
        $__internal_34d39031ccb5925bc57011c4e6c715da214249c79d37e269d09a16d83b0c7ed0->enter($__internal_34d39031ccb5925bc57011c4e6c715da214249c79d37e269d09a16d83b0c7ed0_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "KnpPaginatorBundle:Pagination:twitter_bootstrap_v3_pagination.html.twig"));

        $__internal_81a5942a04f92226d632c195722c68cf5173917c3494e496f34ac03480dc7f44 = $this->env->getExtension("Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension");
        $__internal_81a5942a04f92226d632c195722c68cf5173917c3494e496f34ac03480dc7f44->enter($__internal_81a5942a04f92226d632c195722c68cf5173917c3494e496f34ac03480dc7f44_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "KnpPaginatorBundle:Pagination:twitter_bootstrap_v3_pagination.html.twig"));
...
";
    ...
    ";
            ...
            <a rel=\"prev\" href=\"";
                ...
                echo "\">&laquo;&nbsp;";
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Anterior", array(), "KnpPaginatorBundle"), "html", null, true);
                echo "</a>
        </li>
    ";
            } else {
...
(isset($context["startPage"]) ? $context["startPage"] : $this->getContext($context, "startPage")) != 2)) {
    ...
    ";
            ...
            <a rel=\"next\" href=\"";
                ...
                echo "\">";
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Proximo", array(), "KnpPaginatorBundle"), "html", null, true);
                echo "&nbsp;&raquo;</a>
        </li>
    ";
            } else {
...
";
        ...
        $__internal_34d39031ccb5925bc57011c4e6c715da214249c79d37e269d09a16d83b0c7ed0->leave($__internal_34d39031ccb5925bc57011c4e6c715da214249c79d37e269d09a16d83b0c7ed0_prof);

        
        $__internal_81a5942a04f92226d632c195722c68cf5173917c3494e496f34ac03480dc7f44->leave($__internal_81a5942a04f92226d632c195722c68cf5173917c3494e496f34ac03480dc7f44_prof);
...
{% if pageCount > 1 %}
    ...
    {% if previous is defined %}
        <li>
            <a rel=\"prev\" href=\"{{ path(route, query|merge({(pageParameterName): previous})) }}\">&laquo;&nbsp;{{ 'Anterior'|trans({}, 'KnpPaginatorBundle') }}</a>
        </li>
    {% else %}
        <li class=\"disabled\">
            <span>&laquo;&nbsp;{{ 'Anterior'|trans({}, 'KnpPaginatorBundle') }}</span>
        </li>
    {% endif %}
    ...
    {% if next is defined %}
        <li>
            <a rel=\"next\" href=\"{{ path(route, query|merge({(pageParameterName): next})) }}\">{{ 'Proximo'|trans({}, 'KnpPaginatorBundle') }}&nbsp;&raquo;</a>
        </li>
    {% else %}
        <li class=\"disabled\">
            <span>{{ 'Proximo'|trans({}, 'KnpPaginatorBundle') }}&nbsp;&raquo;</span>
        </li>
    {% endif %}
    </ul>
{% endif %}
", "KnpPaginatorBundle:Pagination:twitter_bootstrap_v3_pagination.html.twig", "C:\\projetos\\cadastro\\vendor\\knplabs\\knp-paginator-bundle/Resources/views/Pagination/twitter_bootstrap_v3_pagination.html.twig");
    }
}
